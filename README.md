...
- [Data-Binding Library](#data-binding-library): enables synchronizing GUI with Model Attributes bidirectionally **(now with [Shine](#shine-data-binding-syntax) syntax support in v2, which was [originally conceived back in 2007]([https://andymaleh.blogspot.com/2007/12/glimmers-built-in-data-binding-syntax.html](https://andymaleh.blogspot.com/2007/12/data-shining-in-glimmer.html)))**.
